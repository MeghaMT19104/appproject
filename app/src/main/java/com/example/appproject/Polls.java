...
class Polls {
    ...
    public Polls(String destination, String price, String time, String date, String creater_uid, String chatroom, String gender, String type, String session, int max_age) {
